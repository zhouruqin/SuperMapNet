...
from mapmaster.models.ins_decoder.pointmask2former import PointMask2TransformerDecoder,PointElementMask2TransformerDecoder
...
class PointElementMask2formerINSDecoder(INSDecoderBase):
    def __init__(self, decoder_ids=(5, ), tgt_shape=None, **kwargs):
        super(PointElementMask2formerINSDecoder, self).__init__(decoder_ids, tgt_shape)
        self.bev_decoder = PointElementMask2TransformerDecoder(**kwargs)